...
import 'package:aqsa_key_game/features/register/data/repository/register_repo.dart';
import 'package:aqsa_key_game/features/register/logic/cubit/register_cubit.dart';
        ...
        body: BlocConsumer<RegisterCubit, RegisterStates>(
          listener: (context, state) {
            if (state is RegisterSuccessState) {
              ...
              layoutCubit.changeButtonNavItem(1);
                ...
                child: Column(
                  children: [
                    Container(
                      ...
                      child: Text(
                        "أنشئ حسابًا للبدأ في صنع الطرق والمسارات في لعبة مفتاح الأقصى.",
                        style: getBoldStyle(
                      ...
                      child: Column(
                        children: [
                          ...
                          TextFormField(
                            ...
                            validator: (value) {
                              if (value == null || value.isEmpty) {
                                return 'من فضلك ادخل رقم التواصل الخاص بك';
                              }
                              return null;
                            },
                            decoration: InputDecoration(
