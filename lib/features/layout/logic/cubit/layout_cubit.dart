import 'package:aqsa_key_game/features/games/views/games_page.dart';
import 'package:aqsa_key_game/features/login/views/login_player_screen.dart';
import 'package:aqsa_key_game/features/register/views/register_admin_screen.dart';
import 'package:aqsa_key_game/features/register/views/register_player_screen.dart';
...
class LayoutCubit extends Cubit<LayoutStates> {
  ...
  int currentButtomNavIndex = CacheHelper.getData(key: 'id') == null ? 0 : 3;
